...
**topIndex** | **Integer** | Gets or sets index of the top visible element of the list. | [optional]
**selectedItems** | **List&lt;Integer&gt;** | Gets or sets array of the selected items in the multiselect list. For single-select list returns array with single item. | [optional]
