...
Try to add eSign using the Aspose.PDF online service https://products.aspose.app/pdf/signature.
...
```groovy
compile "com.aspose:aspose-cloud-pdf:20.7.0"
```
...
* target/aspose-cloud-pdf-20.7.0.jar
* target/lib/*.jar
